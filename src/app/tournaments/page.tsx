...
const allEvents = [
  ...tournaments.map((t) => ({ label: t.title, type: "tournament" as const })),
  ...clinics.map((c) => ({ label: c.title, type: "clinic" as const })),
];
              ...
              <div className="bg-white/[0.03] backdrop-blur-lg border border-white/[0.08] p-6 md:p-10 lg:p-12">
                <form action="#" method="POST" className="space-y-14">
                  ...
                  <div className="pt-4">
                    <button
                      type="submit"
                      className="group w-full md:w-auto relative bg-fsl-coral text-white px-14 py-5 font-barlow text-[15px] font-bold uppercase tracking-[0.2em] overflow-hidden transition-all duration-500 hover:shadow-[0_0_60px_rgba(244,118,124,0.3)] hover:scale-[1.02] active:scale-[0.98]"
                    >
              ...
              <ScrollReveal animation="fade-left" delay={150}>
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link
                      href="/contact"
                      className="group inline-flex items-center gap-3 font-redhat text-[11px] font-bold uppercase tracking-[0.2em] text-white bg-fsl-dark px-8 py-4 hover:bg-fsl-coral transition-all duration-500"
                    >
                      Request Equipment
